    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StatusCzłonkaIpma = table.Column<bool>(type: "bit", nullable: false),
                    Organizacja_NazwaOrganizacji = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Organizacja_NumerNip = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Organizacja_SkrótNazwyOrganizacji = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Organizacja_KodPocztowy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AfiliacjaNaukowaLubBiznesowa = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DaneOsobowe_Imie = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DaneOsobowe_Nazwisko = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DaneOsobowe_AdresEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DaneOsobowe_NrTelefonu = table.Column<string>(type: "nvarchar(max)", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CzlonekJury", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EdycjeKonkursu_CzlonekJury_PrzewodniczącyId",
                        column: x => x.PrzewodniczącyId,
                        principalTable: "CzlonekJury",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FlagaUprawnieńZarządczych = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EkspertIpmaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Asesor", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Asesor_EksperciIpma_EkspertIpmaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CzłonekJuryEdycjaKonkursu_CzlonekJury_CzłonkowieJuryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Projekty_Asesor_AsesorWiodącyId",
            ...
            migrationBuilder.CreateTable(
                name: "PrzedstawicielBiuraNagrody",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DaneOsobowe_Imie = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    DaneOsobowe_AdresEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DaneOsobowe_NrTelefonu = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BiuroNagrodyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrzedstawicielBiuraNagrody", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PrzedstawicielBiuraNagrody_BiuraNagrody_BiuroNagrodyId",
                        column: x => x.BiuroNagrodyId,
                        principalTable: "BiuraNagrody",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OcenyIndywidualne_Asesor_AsesorId",
                        column: x => x.AsesorId,
                        principalTable: "Asesor",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrzedstawicielBiuraNagrody_BiuroNagrodyId",
                table: "PrzedstawicielBiuraNagrody",
                column: "BiuroNagrodyId");
